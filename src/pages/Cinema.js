				...
				{window.localStorage.getItem("isLogedIn") === "true" ? (
					<Container className="mt-5 d-flex align-items-center justify-content-center flex-column">
						...
						<Row className="d-flex mt-5">
							<Col>
								<button
									className="btn border-0 bg-dark p-1 text-white font-size-base"
									onClick={() => handleURL("https://www.youtube.com/watch?v=E4iJOpla4AU")}>
									Jeri Fallen Order
								</button>
								<button
									className="ms-3 btn border-0 bg-dark p-1 text-white font-size-base"
									onClick={() => handleURL("https://www.youtube.com/watch?v=cen-yPSEOiE")}>
									Episode X
								</button>
							</Col>
						</Row>
