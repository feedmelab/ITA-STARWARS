...
export default () => {
	...
	return (
		<Container>
			...
			<Row>
				<Col className="d-flex mt-1 mb-5 flex-row flex-wrap  justify-content-center align-content-center">
					{insetLoad ? (
						<div className="d-flex flex-row">
							<Spinner animation="border" size="sm" className="text-light me-2" />
							<LoadingMessage> Loading from an external API, please wait...</LoadingMessage>
						</div>
					) : (
						<LoadMoreButton className="btn btn-link text-warning text-decoration-none text-sm" role="link" onClick={() => fetchMore()}>
							<MdDownloading /> VIEW MORE
						</LoadMoreButton>
					)}
				</Col>
			</Row>
